        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="request3.jsp">Requested</a>
              </li>
               <li class="nav-item">
                <a class="nav-link" href="decrypt1.jsp">Decrypt</a>
              </li>
               <li class="nav-item">
    ...
    <div class="container">
      ...
      <div class="table-responsive">
		...
		try
           ...
           <td><form action="request2.jsp" method="post"><input type="hidden" value="<%=rs.getString("fid") %>" name="req"><input type="submit" value="Request"></form></td>
            </tr>
           <%
					}
            }
