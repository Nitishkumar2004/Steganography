    ...
    <div class="container">
      ...
      <div class="table-responsive">
		...
		try
					...
					String qry ="select  * from fileup where roll='"+roll+"'"; 
           ...
           <td><form action="request1.jsp" method="post"><input type="hidden" value="<%=rs.getString("fid") %>" name="req"><input type="submit" value="Request"></form></td>
            </tr>
           <%
					}
            }
